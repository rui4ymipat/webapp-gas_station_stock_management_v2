              ...
              <div class="setfont1">
                <div class="row1">
                  <div class="setborder" style="width: 80%;">
                    ...
                    <textarea name="t" id="t" cols="50" rows="11" style="width: 90%;"><?php echo $row3['text']; ?></textarea>
                          ...
                          <?php for ($i = 0; $i < count($id); $i++) { ?>
                            <tr>
                              ...
                              ?>
                                ...
                                <td style="font-size: 155%;font-weight: 550;">แอดมิน</td>
                              <?php
                              } else {
                              ?>
                                <td style="font-size: 85%;">
                                ...
                                <td style="font-size: 155%;font-weight: 550;">ผู้ดูแล</td>
                              <?php
                              }
                              ?>
                            </tr>
