...
if (empty($g91) && empty($g95) && empty($de)) {
    ...
    if (mysqli_num_rows($result) == 0) {
        ...
        $userQuery = "update gastank set value = $g91 , name_stamp = '$name' ,timestamp = '$time' where gas_id = 1 and date = '$date'";
        $result = mysqli_query($connect, $userQuery);
    }
    ...
    if (mysqli_num_rows($result) == 0) {
        ...
        $userQuery = "update gastank set value = $g95 , name_stamp = '$name' ,timestamp = '$time' where gas_id = 2 and date = '$date'";
        $result = mysqli_query($connect, $userQuery);
    }
    ...
    if (mysqli_num_rows($result) == 0) {
        ...
        $userQuery = "update gastank set value = $de , name_stamp = '$name' ,timestamp = '$time' where gas_id = 3 and date = '$date'";
        $result = mysqli_query($connect, $userQuery);
    }
