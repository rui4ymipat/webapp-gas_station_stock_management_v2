                      ...
                      <div class="set_line">
                        ...
                        <table class="account">
                          ...
                          <tr>
                            ...
                            <td><input type="text" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" name="95d_a1" placeholder="ส่วนลด" style="margin-left: 15px"></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td><input type="text" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" name="Ded_a1" placeholder="ส่วนลด" style="margin-left: 15px"></td>
                          </tr>
                        </table>
                      ...
                      <div class="set_line">
                        ...
                        <table class="account">
                          ...
                          <tr>
                            ...
                            <td><input type="text" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" name="95d_a2" placeholder="ส่วนลด" style="margin-left: 15px"></td>
                          </tr>

                          <tr>
                            <td class="name">Diesel</td>
                            <td><input type="text" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" name="Dep_a2" placeholder="ราคา"></td>
                            <td><input type="text" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" name="Ded_a2" placeholder="ส่วนลด" style="margin-left: 15px"></td>
                          </tr>
                        </table>
                      ...
                      <div class="set_line">
                        ...
                        <table class="account">
                          ...
                          <tr>
                            ...
                            <td><input type="text" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" name="95d_a3" placeholder="ส่วนลด" style="margin-left: 15px"></td>
                          </tr>

                          <tr>
                            <td class="name">Diesel</td>
                            <td><input type="text" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" name="Dep_a3" placeholder="ราคา"></td>
                            <td><input type="text" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" name="Ded_a3" placeholder="ส่วนลด" style="margin-left: 15px"></td>
                          </tr>
                        </table>
                      </div>
