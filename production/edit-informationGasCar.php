                        ...
                        <div class="dashboard_graph">
                            ...
                            <?php if ($_SESSION['user_level'] != 1) { ?>
                                <div class="setfont1">
                                    ...
                                    ?>
                                    <h1 style="font-weight: 800;color: #2B3E54;font-size: 180%;">แก้ไขข้อมูลของวันที่ <?php echo $Tdate; ?></h1>
                                    <div class="setborder">
                                        <form action="edit-inforCar-pro.php" method="GET">

                                            <div class="column1">
                                                <div class="showdetail">รถขนน้ำมัน</div>
                                                <?php

                                                $Q = "Select name from car where id = $re_car";
                                                $result = mysqli_query($connect, $Q);
                                                $row = mysqli_fetch_assoc($result)
                                                ?>
                                                <table>
                                                    <tr>
                                                        <td class="name" style="font-size: 150%;">เลขทะเบียนรถขนน้ำมัน <?php echo $row['name']; ?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="column2">
                                            ...
                                            <div class="column3">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" name="other" value="<?php echo $row['other_price']; ?>"></td>
                                                        <td class="lit">บาท</td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <input type="hidden" name="cars" value="<?php echo $re_car; ?>">
