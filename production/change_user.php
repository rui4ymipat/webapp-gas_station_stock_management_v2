                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="dashboard_graph">
                            ...
                            <div class="setfont1">
                                <div class="setborder">
                                    <form action="change-pro.php" method="POST">
                                        <div class="showdetail">แก้ไขข้อมูลบัญชี</div>
                                        <?php
                                        require_once "connect.php";
                                        $id = $_GET['id'];
                                        ...
                                        <table>
                                            <tr>
                                                <td class="name">ID </td>
                                                <td><input type="text" name="id" placeholder="<?php echo $row['username'] ?>" value="<?php echo $row['username'] ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="name">Password </td>
                                                <td><input type="password" name="pass" placeholder="<?php echo $row['password'] ?>" value="<?php echo $row['password'] ?>"></td>
                                            </tr>
                                            <tr>
                                                <td class="name">ชื่อ</td>
                                                <td><input type="text" name="Fname" placeholder="<?php echo $row['Fname'] ?>" value="<?php echo $row['Fname'] ?>"></td>
                                            </tr>
                                            <tr>
